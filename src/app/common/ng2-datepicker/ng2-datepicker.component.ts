...
import * as SlimScroll from 'ng2-slimscroll';
...
@Component({
  moduleId: module.id,
  selector: 'app-ng2-datepicker',
  templateUrl: 'ng2-datepicker.component.html',
  // styleUrls: ['ng2-datepicker.component.css'],
...
export class DatePickerComponent implements ControlValueAccessor, OnInit {
  ...
  ngOnInit() {
    ...
    if (typeof window !== 'undefined') {
      ...
      body.addEventListener('click', e => {
        if (!this.opened || !e.target) { return null; }
  ...
  incrementYear(e: MouseEvent, increment: boolean) {
    e.preventDefault();
    setTimeout(() => {
  ...
  private onTouchedCallback: () => void = () => { return true; };
  private onChangeCallback: (_: any) => void = () => { return true; };
...
export class DatePickerOptions {
  ...
  constructor(obj?: IDatePickerOptions) {
    ...
    this.placeHolder = obj && obj.placeHolder ? obj.placeHolder : 'Date';
  }
}
